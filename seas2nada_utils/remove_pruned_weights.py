# useage: python3 remove_pruned_weights.py finetuned reference_model trained_model save_model_name structured pruning_method 0.x
...
prune_unit = sys.argv[5] # (structured or unstructured)
pruning_method = sys.argv[6] # (l1 or random)
pruned_ratio = float(sys.argv[7])
...
old_dict = torch.load(reference_model)
