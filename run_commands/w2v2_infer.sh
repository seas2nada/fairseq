...
for subset in "dev_clean" "dev_other" "test_clean" "test_other"; do
    ...
    finetuned_model=$PWD/trained_models/w2v2_base_MPI_10m_1/0/checkpoints/checkpoint_best_pw_removed.pt
    # finetuned_model=$PWD/trained_models/wav2vec_small_10m_converted.pt
